...
const Bundle = () => {
	return (
		<div className="rounded-[43px] border-[2px] border-boost-black-1 max-w-[380px] mt-10">
			<div className="rounded-t-[43px] bg-boost-tan-1 flex justify-center flex-col items-center p-10 gap-6 relative">
				...
				<h3
					className={`text-[52px] leading-[46px] text-boost-black-1 text-center mt-10 `}>
					Aggressive Plan
				</h3>
				<p className="text-boost-black-1 text-7xl ">
					$350 <span className="text-2xl">/month</span>
				</p>
			</div>
